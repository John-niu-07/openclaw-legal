...
1. 检查 `../../../../../legal-clinic/CLAUDE.md`。如已填充且无 `--redo`，在覆盖前确认。
...
6. 写入 `../../../../../legal-clinic/CLAUDE.md`，包括 `## 谁在使用这个插件` 和 `## 可用集成`。展示指导风格选择和实践领域模板供确认。
...
**`--check-integrations`：** 仅重新运行 Part 0 集成可用性检查。更新 `../../../../../legal-clinic/CLAUDE.md` 中的 `## 可用集成`，不触及身份、伦理前置条件、指导风格或实践领域模板。在添加或移除 MCP 连接器后使用。
...
> 完成。你诊所的配置位于 `../../../../../legal-clinic/CLAUDE.md`——一份你可以直接阅读和编辑的纯文本文件。你的任何回答都可以更改：
>
> - 直接编辑文件以快速更改
