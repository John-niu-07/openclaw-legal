...
1. **读取配置。** 读取 `../../../../../regulatory-legal/CLAUDE.md`。如果插件配置不存在或仍包含 `[PLACEHOLDER]` 值，说明："你还没有运行设置。先运行 `/regulatory-legal:cold-start-interview`——定制功能用于调整已有的配置。"
...
5. **对共享配置的变更**（公司名称、行业、管辖区域、执业设置、阶段）：写入 `../../../../../company-profile.md` 并注明此变更影响所有插件。
