...
**在阅读合同之前，阅读 `../CLAUDE.md`。** 如果文件缺失或仍有占位符，弹出以下提示：
...
`../CLAUDE.md` 中的审查指引是真实来源。它告诉你本团队的标准立场、曾经接受的让步、从不接受的内容、审批权限以及需要首先检查的deal-breaker。
...
>
> **来源归属。** 引用法规、规章或案例时，标注引用来源：`[北大法宝]`/`[wkinfo浏览器自动化]`、`[网络搜索 — 需核实]`、`[模型知识 — 需核实]`、`[用户提供]`。
